  ...
  return (
    <div className='my-3 '>
      <div className='p-4'>
        ...
        <p className='my-1 text-xs text-gray-400'>닉네임은 카카오 기본 정보에 따라 등록되며, 수정할 수 있어요</p>
      </div>
      <div className='my-3 px-4'>
        ...
        <p className='my-2 text-xs text-gray-400'> * 카카오 가입계정은 기본 정보를 수정할 수 없어요</p>
      </div>
      <div className='mb-5 mt-6 w-full text-center'>
        <button className='text-xs underline' onClick={handleLogout} >로그아웃</button>
      </div>
      <div className='h-2 w-full bg-gray-100'></div>
      <div className='mb-5 mt-6 w-full text-center'>
        <button className='text-xs text-gray-400' onClick={handleWithdrawalmembership}>회원 탈퇴</button>
      </div>
    </div>
  )
}
